...
import { PriceTrendDataPoint, RevenueExpensesDataPoint } from "@/types/marketTrends";
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div className="bg-white border border-[#E5E7EB] rounded-xl shadow-sm p-4">
                ...
                <p className="text-[10px] text-[#9CA3AF] mt-1 mb-3">2-year trend • Data from Redfin</p>
            ...
            <div className="bg-white border border-[#E5E7EB] rounded-xl shadow-sm p-4">
                <div className="flex items-start justify-between mb-2">
                    <div>
                        ...
                        <p className="text-[10px] text-[#9CA3AF] mt-1">2-year trend • Data from Redfin</p>
                    </div>
                </div>
