...
export const DashboardHeader: React.FC<DashboardHeaderProps> = ({
    ...
    return (
        <header className="sticky top-0 z-50 bg-white border-b border-[#E5E7EB] px-4 md:px-6 h-14 flex items-center justify-between gap-4">
            {/* Logo */}
            ...
            <div className="flex items-center gap-3 shrink-0">
                {/* Notification bell */}
                <button className="relative w-8 h-8 flex items-center justify-center rounded-lg hover:bg-[#F3F4F6] transition">
                ...
                {/* User profile */}
                <button className="flex items-center gap-2 hover:bg-[#F3F4F6] rounded-lg pr-2 pl-1 py-1 transition">
                    <Image
                        src={userAvatar}
                        alt={userName}
                        width={30}
